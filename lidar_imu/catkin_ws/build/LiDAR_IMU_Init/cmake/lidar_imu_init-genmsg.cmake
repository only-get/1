...
set(MSG_I_FLAGS "-Ilidar_imu_init:/home/lee/calibration/lidar_imu/catkin_ws/src/LiDAR_IMU_Init/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lee/calibration/lidar_imu/catkin_ws/src/LiDAR_IMU_Init/msg/Pose6D.msg" NAME_WE)
add_custom_target(_lidar_imu_init_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lidar_imu_init" "/home/lee/calibration/lidar_imu/catkin_ws/src/LiDAR_IMU_Init/msg/Pose6D.msg" ""
)

get_filename_component(_filename "/home/lee/calibration/lidar_imu/catkin_ws/src/LiDAR_IMU_Init/msg/States.msg" NAME_WE)
add_custom_target(_lidar_imu_init_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lidar_imu_init" "/home/lee/calibration/lidar_imu/catkin_ws/src/LiDAR_IMU_Init/msg/States.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lidar_imu_init)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lidar_imu_init\")")
  # install generated code
  install(
